...
if (isset($_SESSION['isLoggedIn']) && $_SESSION['isLoggedIn'] === true) {
    ...
    $queryCarrito = "SELECT carrito.id_articulo, carrito.cantidad, articulos.nombre AS nombre_articulo, articulos.precio, articulos.imagen
                    FROM carrito 
    ...
    if ($resultCarrito->num_rows > 0) {
        ...
        while ($row = $resultCarrito->fetch_assoc()) {
            // Formatear el precio con punto de miles
